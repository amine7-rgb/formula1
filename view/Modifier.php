...
?>
        ...
        <tr>
          ...
          <th> Nom </th>
          <th><input id="nom "type="text" name="nom" value="<?php  echo $res['nom']; ?>"  required placeholder=""/></th>
        </tr>
        
        <th>Puissance</th>
          <th><input id="puissance" type="text" name="puissance" value="<?php  echo $res['puissance']; ?>"/></th>
        </tr>
